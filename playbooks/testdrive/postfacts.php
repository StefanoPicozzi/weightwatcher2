...
$url = "http://".$fqdn."/kie-server/services/rest/server/containers/instances/watch";
$username  = "erics";
$password = "jbossbrms1!";
...
try {
	...
	curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/xml', 'X-KIE-ContentType: XSTREAM'));
